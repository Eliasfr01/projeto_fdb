  ...
  return(
    <div>
      ...
      <div style={{padding: '8px 50px 0px' }}>
        ...
        <Typography variant='h6' style={{ marginTop: '20px', fontSize: '15px', display: 'flex', justifyContent: 'center' }}>100% de frequência; 0 presença em horas; 0 faltas em horas</Typography>
